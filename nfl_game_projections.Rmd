...
if  Team(f'{home_team_input}').team_abr == 'LV':
    home_elo = hist_elo[(hist_elo.team1 == 'OAK') | (hist_elo.team2 == 'OAK') | (hist_elo.team2 == 'LV') | (hist_elo.team1 == 'LV')] 
elif Team(f'{home_team_input}').team_abr == 'WAS':
    home_elo = hist_elo[(hist_elo.team1 == 'WSH') | (hist_elo.team2 == 'WSH')]
elif Team(f'{home_team_input}').team_abr == 'LA':
    home_elo = hist_elo[(hist_elo.team1 == 'LAR') | (hist_elo.team2 == 'LAR')]
else:
...
home_team_input = 'Baltimore Ravens'
away_team_input = 'Houston Texans' 
...
for i in range(len(ht_df[ht_df['season'] == 2022])):
  if i < (len(elo_temp_home_2022)-1):
    ...
    ht_df.loc[ ht_df[ht_df.season == 2022].index[i],'elo'] = team_ref.loc[home_team_input,'Current ELO'] + counter*20
    counter+=1
...
for i in range(len(at_df[at_df['season'] == 2022])):
  if i < (len(elo_temp_away_2022)-1):
    ...
    at_df.loc[ at_df[at_df.season == 2022].index[i],'elo'] = team_ref.loc[away_team_input,'Current ELO'] + counter*20
    counter+=1
...
```{r}
home_model <- lm(points_scored~epa+passing_yards+rushing_yards+turnovers+takeaways + epa_allowed + elo + home_away,data=py$ht_df)
away_model <- lm(points_scored~epa+passing_yards+rushing_yards+turnovers+takeaways + epa_allowed + elo + home_away,data=py$at_df)
...
home_score_proj = exp_epa*(r.home_model['coefficients'][1])                                   +exp_passing_yards*(r.home_model['coefficients'][2])                                          +exp_rushing_yards*(r.home_model['coefficients'][3])                                              +exp_turnovers*(r.home_model['coefficients'][4])                                                  +exp_takeaways*(r.home_model['coefficients'][5])                                                +exp_epa_allowed*(r.home_model['coefficients'][6])                                                                                               
...
away_score_proj = exp_epa*(r.away_model['coefficients'][1])                                   +exp_passing_yards*(r.away_model['coefficients'][2])                                            +exp_rushing_yards*(r.away_model['coefficients'][3])                                                +exp_turnovers*(r.away_model['coefficients'][4])                                                  +exp_takeaways*(r.away_model['coefficients'][5])                                                +exp_epa_allowed*(r.away_model['coefficients'][6])                                                                  +(team_ref.loc[away_team_input,'Current ELO'])*(r.away_model['coefficients'][7])                                                                +r.away_model['coefficients'][0] 
