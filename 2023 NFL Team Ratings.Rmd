...
# model_pred = read.csv("C:\\Users\\harri\\sports-app-server\\week1_model_pred.csv")
# 
# for (row in 1:nrow(NFL_table_clean)){
# 
#   if (NFL_table_clean$Team[row] %in% word( model_pred$Home_Team,-1) ){
#     ht = model_pred$Home_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
#     at = model_pred$Away_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
#     away_spread = model_pred$Away_Spread[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
#     home_spread = model_pred$Home_Spread[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
#     midpoint = model_pred$Midpoint[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
# 
#     NFL_table_clean$Playoffs[row] = ifelse( home_spread <  away_spread, -abs(midpoint), abs(midpoint) )
#   }else{
#     ht = model_pred$Home_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
#     at = model_pred$Away_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
#     away_spread = model_pred$Away_Spread[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
#     home_spread = model_pred$Home_Spread[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
#     midpoint = model_pred$Midpoint[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
# 
#     NFL_table_clean$Playoffs[row] = ifelse( away_spread <  home_spread, -abs(midpoint), abs(midpoint) )
#   }
# 
# }
# 
# 
# 
# NFL_table_clean <- NFL_table_clean %>% rename_at('Playoffs', ~'Model')
```


```{r}
model_pred = read.csv("C:\\Users\\Harrison Eller\\NFL_Analytics\\model_pred.csv")
...
for (row in 1:nrow(NFL_table_clean)){
  ...
  if (NFL_table_clean$Team[row] %in% word( model_pred$Home_Team,-1) ){
    ht = model_pred$Home_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
    at = model_pred$Away_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
    away_spread = model_pred$Away_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)] - model_pred$Home_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]
    home_spread = model_pred$Home_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)] - model_pred$Away_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]  
    
    #midpoint = model_pred$Midpoint[amatch(NFL_table_clean$Team[row] ,word( model_pred$Home_Team,-1), maxDist = 2)]

    #NFL_table_clean$Playoffs[row] = ifelse( home_spread <  away_spread, -abs(midpoint), abs(midpoint) )
    NFL_table_clean$Projection[row] = ifelse(home_spread < 0, paste("+",substr(as.character(round(away_spread,1)),1,5),sep=""), paste("-",as.character(round(home_spread,1)),sep=""))
  }else{
    ht = model_pred$Home_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
    at = model_pred$Away_Team[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
    away_spread = model_pred$Away_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]-model_pred$Home_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
    home_spread = model_pred$Home_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)] - model_pred$Away_Score[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]
    #midpoint = model_pred$Midpoint[amatch(NFL_table_clean$Team[row] ,word( model_pred$Away_Team,-1), maxDist = 2)]

    #NFL_table_clean$Playoffs[row] = ifelse( away_spread <  home_spread, -abs(midpoint), abs(midpoint) )
    NFL_table_clean$Projection[row] = ifelse(away_spread < 0, paste("+",substr(as.character(round(away_spread,1)),2,5),sep=""),  paste("-",as.character(round(away_spread,1)),sep=""))
  }
...
```{r}
# ratings = read.csv("C:\\Users\\Harrison Eller\\sports-app-server\\power_rankings.csv")
# 
# 
# for (row in 1:nrow(NFL_table_clean)){
# 
#     #ht = ratings$Home_Team[amatch(NFL_table_clean$Team[row] ,word( ratings$team_name,-1), maxDist = 2)]
#     #at = ratings$Away_Team[amatch(NFL_table_clean$Team[row] ,word( ratings$team_name,-1), maxDist = 2)]
#     home_EPA =ratings$AVG_EPA[amatch(NFL_table_clean$Team[row] ,word( ratings$team_name,-1), maxDist = 2)] 
#     home_EPA_Allowed = ratings$AVG_EPA_Allowed[amatch(NFL_table_clean$Team[row] ,word( ratings$team_name,-1), maxDist = 2)] 
#     
#     NFL_table_clean$OSRS[row] = home_EPA
#     NFL_table_clean$DSRS[row] = home_EPA_Allowed
#     NFL_table_clean$SRS[row] = home_EPA_Allowed + home_EPA 
#     
# }
# 
# NFL_table_clean$SRS = round(rank(NFL_table_clean$SRS ))
```
...
div(class = "team-ratings",
    div(class = "title",
        h2("2023 NFL Team Ratings & Projections (Week 17)"),
        "Ratings and predictions for the 2023 NFL season"),
  table,
